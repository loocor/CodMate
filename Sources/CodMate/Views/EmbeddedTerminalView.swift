...
final class EmbeddedTerminalCoordinator: NSObject {
    ...
    fileprivate func bootstrap(_ view: LocalProcessTerminalView) {
        ...
        updateTheme(for: view, appearance: view.effectiveAppearance)
        
        // Observe appearance changes
        appearanceObserver = view.observe(\.effectiveAppearance, options: [.new]) { [weak self] termView, _ in
...
struct EmbeddedTerminalView: NSViewRepresentable {
    ...
    func makeCoordinator() -> EmbeddedTerminalCoordinator { .init(initialCommands: initialCommands) }
            ...
            HStack(spacing: 12) {
                ...
                Button("Open Terminal") {
                    if #available(macOS 10.15, *) {
                        ...
                        NSWorkspace.shared.launchApplication(withBundleIdentifier: "com.apple.Terminal", options: [], additionalEventParamDescriptor: nil, launchIdentifier: nil)
                    }
                }
            }
        }
